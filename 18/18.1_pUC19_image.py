...
pUC19 = Image.new('RGB', SIZE, 'white')
DRAW = ImageDraw.Draw(pUC19)
...
LacZ_START, LacZ_END = get_angle(146), get_angle(469)
AMP_START, AMP_END = get_angle(1626), get_angle(2486)
ORI_START, ORI_END = get_angle(852), get_angle(1466)

# drawing the plasmid
BOX = (50, 50, 450, 450)
DRAW.pieslice(BOX, 0, 360, fill='gray')
DRAW.pieslice(BOX, LacZ_START, LacZ_END, fill='blue')
...
draw_arrow_tip(LacZ_END, 10, 'blue')
...
DRAW.text((300, 380), "LacZ", fill=(0, 0, 0))

pUC19.save('pUC19.png')
